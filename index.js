...
const person1 = new Person('nick', 28);
...
const lamdasian1 = new Lambdasian({name:'Nick',age:28, location:'Summit'});
console.log('task 3:', lamdasian1.speak());
/*
  TASK 4
...
class Instructor extends Lambdasian {
  constructor({name, age, location, specialty, favLanguage, catchPhrase}){
    super({age, name, location, specialty, favLanguage, catchPhrase});
...
const instructor1 = new Instructor({name: 'Eric', age: 25, location: 'SF', specialty:'QA', favLanguage:'Javascript', catchPhrase:'og surprise surprise'});
console.log('task 4:', instructor1.demo('QA testing'));
/*
  TASK 5
...
const student1 = new Student({name:'Nick', age:28, location:'Provo', previousBackground: 'Tech Client Success', className: 'Class', favSubjects: ['Javascript']})
console.log('task 5:', student1);
/*
  TASK 6
